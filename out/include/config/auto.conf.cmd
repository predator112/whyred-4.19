deps_config := \
	...
	drivers/hwtracing/google/Kconfig \
	...
	drivers/media/platform/msm/camera_v2-whyred/Kconfig \
...
ifneq "$(CC_VERSION_TEXT)" "Predator clang version 14.0.0 (https://github.com/llvm/llvm-project 4fc98ca6174ad173abc48646b713c91fd50e7182)"
include/config/auto.conf: FORCE
endif
ifneq "$(srctree)" ".."
include/config/auto.conf: FORCE
...
ifneq "$(CLANG_FLAGS)" "--target=aarch64-linux-gnu --prefix=/predator/build/kernel/clang/bin/aarch64-linux-gnu- --gcc-toolchain=/predator/build/kernel/clang -no-integrated-as  -Wno-misleading-indentation  -Wno-bool-operation -Werror=unknown-warning-option  -Wno-unsequenced"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm64"
include/config/auto.conf: FORCE
